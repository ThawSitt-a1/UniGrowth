...
<head>
    ...
    <title>{{ $platformName ?? 'UniGrowth' }} — Forgot Password</title>
    <!-- Bootstrap 5 CDN -->
                ...
                <div class="w-100" style="max-width: 32rem;">
                    ...
                    <div class="form-card p-4 p-lg-5">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <h2 class="fw-bold mb-1" style="color: #1f2937; font-size: 1.5rem;">Forgot Password?</h2>
                            <p class="text-muted small mt-2">No worries — we'll help you reset it</p>
                        </div>
